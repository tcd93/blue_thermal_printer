...
//    public static byte[] SELECT_PRINT_SHEET = {0x1B, 0x63, 0x30, 0x02};
    static byte[] FEED_PAPER_AND_CUT = {0x1D, 0x56, 66, 0x00};
...
//    public static final byte[] FS_FONT_ALIGN = new byte[] { 0x1C, 0x21, 1, 0x1B, 0x21, 1 };
    static final byte[] ESC_ALIGN_LEFT = new byte[] { 0x1b, 'a', 0x00 };
    static final byte[] ESC_ALIGN_RIGHT = new byte[] { 0x1b, 'a', 0x02 };
    static final byte[] ESC_ALIGN_CENTER = new byte[] { 0x1b, 'a', 0x01 };
